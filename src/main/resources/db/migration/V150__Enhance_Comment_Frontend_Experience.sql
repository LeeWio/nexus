...
ALTER TABLE blog_comment ADD COLUMN is_featured BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE blog_comment ADD COLUMN is_deleted_placeholder BOOLEAN NOT NULL DEFAULT FALSE;

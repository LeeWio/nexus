...
-- 2. Add some comments
INSERT IGNORE INTO `blog_comment` (`id`, `content`, `status`, `post_id`, `user_id`, `created_at`, `updated_at`, `created_by`, `is_deleted`)
VALUES 
(1, 'Great post!', 'APPROVED', 1, 1, NOW(), NOW(), 'GUEST', 0),
(2, 'Thanks for sharing.', 'PENDING', 1, 1, NOW(), NOW(), 'GUEST', 0),
(3, 'Very helpful.', 'APPROVED', 2, 1, NOW(), NOW(), 'GUEST', 0);
...
INSERT INTO `sys_visit_log` (`ip_address`, `request_url`, `user_agent`, `visit_time`, `created_at`, `is_deleted`)
VALUES 
('127.0.0.1', '/', 'Mozilla', NOW() - INTERVAL '1' DAY, NOW() - INTERVAL '1' DAY, 0),
('192.168.1.1', '/post/welcome-to-nexus', 'Chrome', NOW() - INTERVAL '1' DAY, NOW() - INTERVAL '1' DAY, 0);

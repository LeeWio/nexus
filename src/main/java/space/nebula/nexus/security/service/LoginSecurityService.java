...
public interface LoginSecurityService {
     ...
     * Throws a BusinessException if locked.
     *
     ...
     * Increments the failure count and applies lock if threshold reached.
     *
    ...
    /**
     * Resets the login failure count for the specified user.

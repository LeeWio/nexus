...
/**
 * Global MapStruct configuration to ensure consistency and eliminate unmapped
 * warnings. Standardizes how system fields (auditing, soft delete) are handled
 * across all mappers.
 */
@MapperConfig(componentModel = MappingConstants.ComponentModel.SPRING, unmappedTargetPolicy = ReportingPolicy.ERROR, // Force
																														// error
																														// on
																														// unmapped
																														// properties

...
public interface INotificationService {
     ...
     *
     * @param recipient user who owns the notification
     * @param title concise notification title
     * @param content notification details
     * @param type notification category
     * @param link optional application link related to the notification
     */
	 ...
	 *
	 * @param postId published post identifier

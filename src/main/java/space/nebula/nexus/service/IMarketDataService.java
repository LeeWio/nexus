...
{
	/**
	 * Retrieves market indices for the requested period, using cached data when available.
	 *
	 * @param period market data period
	 ...
	 *
	 * @param symbol market index symbol
	 * @param period market data period
	...
	/**
	 * Fetches fresh market indices from the upstream provider and replaces the cache.
	 *
	 * @param period market data period

 ...
 *
 * @param continueReading
 *            incomplete reading sessions ordered by recent activity
 * @param recentFavorites
 *            recently favorited posts not already shown in continue reading
 * @param recommendations
 *            unseen posts selected from user interests or community popularity
 */

...
public record CommentResponse(@Schema(description = "Comment ID") Long id,
		...
		@Schema(description = "Author username") String username, @Schema(description = "Author display name") String nickname,
		@Schema(description = "Author avatar URL") String avatar, @Schema(description = "Moderation status") CommentStatus status,

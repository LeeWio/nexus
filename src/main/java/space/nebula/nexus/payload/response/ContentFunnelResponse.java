...
public record ContentFunnelResponse(
		@Schema(description = "Applied optional post filter") Long postId,
		@Schema(description = "Start of the reporting window") LocalDateTime start,
		@Schema(description = "End of the reporting window") LocalDateTime end,
		long impressions,
		long clicks,
		long readers25Percent,
		long readers50Percent,
		long readers75Percent,
		long completedReads,
		long likes,
		long favorites,
		long verifiedSubscriptions,
		...
		@Schema(description = "Completion rate from click to completed read") double completionRate) implements Serializable {

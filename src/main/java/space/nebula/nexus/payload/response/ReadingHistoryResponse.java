 ...
 * @param progressPercent last recorded progress percentage
 * @param positionAnchor frontend-defined stable reading position
 * @param lastReadAt most recent reading time
 * @param completedAt time at which reading reached 100 percent
 */

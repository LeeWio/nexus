 ...
 *
 * @param name
 *            collection name unique within the current user's library
 * @param description
 *            optional collection description
 */
@Schema(description = "Personal post collection request")
public record PostCollectionRequest(@NotBlank @Size(max = 80) @Schema(description = "Collection name") String name,

...
public record PostRequest(
		...
		@Schema(description = "Full URL to the cover image") String coverImage,
		...
		@Schema(description = "Whether the post is highlighted/pinned", example = "false") Boolean isFeatured,

		@Schema(description = "ID of the category this post belongs to", example = "1") Long categoryId,

		@Schema(description = "ID of the series this post belongs to", example = "1") Long seriesId,

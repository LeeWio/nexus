...
public class CommentModeratedEvent extends ApplicationEvent
{
	 ...
	 * @param commentId moderated comment identifier
	 * @param authorId comment author identifier
	 * @param replyRecipientId parent comment author identifier, or {@code null}
	 * @param authorUsername comment author's display identifier
	 * @param status moderation outcome
	 * @param link frontend link to the approved comment, or {@code null}
	 */

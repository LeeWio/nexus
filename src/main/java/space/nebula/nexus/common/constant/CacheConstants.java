...
/**
 * Constants for Redis cache keys and prefixes.
 * Follows the naming convention: nexus:{module}:{sub_module}:{identifier}
 */
public final class CacheConstants {
    ...
    /**
     * Build a full cache key compatible with Spring Cache's Redis naming convention.
     * Use this when manually deleting or accessing Spring-managed cache entries via RedisUtil.
     */

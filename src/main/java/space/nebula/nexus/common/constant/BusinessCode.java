...
public enum BusinessCode {
    ...
    INVALID_TOKEN(40101, "Invalid or expired token"),
    BAD_CREDENTIALS(40102, "Incorrect username or password"),
    ...
    POST_NOT_FOUND(40402, "Post not found"),
    CATEGORY_NOT_FOUND(40403, "Category not found"),
    ...
    POST_ALREADY_PUBLISHED(40010, "Post is already published"),
    POST_NOT_PUBLISHED(40011, "Post is not yet published"),

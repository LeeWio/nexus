...
/**
 * Controller for administrative blog post management.
 * Handles CRUD operations, autosave, and content revisions.
 */
...
public class AdminPostController {
    ...
    public ApiResponse<PostResponse> retrievePost(
            @Parameter(description = "Unique ID of the post", example = "1") 
    ...
    public ApiResponse<PostResponse> revertToRevision(
            @Parameter(description = "ID of the post") @PathVariable Long id, 

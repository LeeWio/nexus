...
/**
 * Controller for administrative friend link management.
 * Provides endpoints for moderating external link applications and managing the blogroll.
 */
...
public class AdminFriendLinkController {
    ...
    public ApiResponse<Void> moderateFriendLink(
            @Parameter(description = "Friend Link ID") @PathVariable Long id, 

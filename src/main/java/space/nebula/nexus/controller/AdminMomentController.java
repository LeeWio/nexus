...
/**
 * Controller for managing micro-blog posts (Moments).
 * Allows administrators to create, update, and organize brief status updates.
 */
...
public class AdminMomentController {
    ...
    public ApiResponse<MomentResponse> getMomentById(
            @Parameter(description = "Moment ID") @PathVariable Long id) {

...
public class MockRedisConfig {
    ...
    public RedisConnectionFactory redisConnectionFactory() {
        ...
        // Mock specific scan commands to return empty cursors to avoid NPEs in scheduled tasks
    ...
    public org.springframework.data.redis.core.StringRedisTemplate stringRedisTemplate() {
        org.springframework.data.redis.core.StringRedisTemplate template = Mockito.mock(org.springframework.data.redis.core.StringRedisTemplate.class);
        Mockito.when(template.execute(Mockito.any(), Mockito.anyList(), Mockito.any(), Mockito.any(), Mockito.any())).thenReturn(1L);
        return template;
    }
}
